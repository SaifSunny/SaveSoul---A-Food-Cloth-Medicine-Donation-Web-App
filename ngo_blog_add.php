...
if(isset($_POST['submit'])){
    ...
    $extensions_arr = array("jpg","jpeg","png","gif");
            ...
            $query = "SELECT * FROM blog WHERE poster_id = '$ngo_id' and `role`='NGO' AND topic = '$title'";
            ...
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        VALUES ('$title','$name', '$description', '$cause_id', '$date', '$ngo_id', 'NGO')";
        ...
        <div class="main">
            <div class="row">
                <div class="col-md-9" style="padding-bottom:30px;">
                    ...
                    <p><a href="ngo_home.php">Dashboard</a> / <a href="ngo_causes.php">Blog Post</a>/ Add
                        Post</p>
                </div>
            </div>
