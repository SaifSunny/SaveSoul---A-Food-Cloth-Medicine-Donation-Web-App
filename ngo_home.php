    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="ngo_home.php" class="nav-link active" aria-current="page"
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card mx-auto"
                        ...
                        <div class="card-body" style="text-align:center; font-size:18px;">
                            <?php
                                    $sql = "SELECT * from donation where poster_id = $ngo_id and `role`='NGO' ";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $row_cnt?></h1>
                ...
                <div class="col-md-3">
                    <div class="card mx-auto"
                        ...
                        <div class="card-body" style="text-align:center; font-size:18px;">
                            <?php
                                    $sql = "SELECT * from blog where poster_id = $ngo_id and `role`='NGO'";
                                    $result = mysqli_query($conn, $sql);
                                    $row_cnt = $result->num_rows;
                                ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $row_cnt?></h1>
            ...
            <h3 style="font-size:24px;margin-bottom:40px">My Causes
                        ...
                        <div class="col-lg-12" style="">
                            ...
                            <?php 
                                ...
                                $sql = "SELECT * FROM causes where poster_id = $ngo_id and `role`='NGO' ORDER BY cause_id";
                                $result = mysqli_query($conn, $sql);
                                if($result){
