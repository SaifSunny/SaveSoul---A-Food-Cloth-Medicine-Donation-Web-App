                ...
                <?php
                                ...
                                if($result){
                                    while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        $sql1 = "SELECT * from ngo WHERE ngo_id=$ngo_id";
                                        $result1 = mysqli_query($conn, $sql1);
                                        $row1=mysqli_fetch_assoc($result1);
                                        $ngo_name = $row1['ngo_name'];
                                        $status = $row1['status'];
                                        $ngo_img = $row1['ngo_img'];

                            ?>
                <div class="col-12 col-lg-12 col-xl-12 border-right">
                    <a href="donner_messages.php?room_id=<?php echo $room_id?>"
                        class="list-group-item list-group-item-action border-0 d-flex justify-content-between">
                        <div class="d-flex align-items-start">
                            <img src="img/ngos/<?php echo $ngo_img?>" class="rounded-circle mr-1" alt="" width="50" style="object-fit: cover;"
                                height="50">
                            <div class="flex-grow-1 ml-3" style="padding-left:30px;font-size:18px;fontweight:700;">
                                <?php echo $ngo_name?>
