        ...
        <div class="main">
            <div class="row">
                <div class="col-md-9" style="padding-bottom:30px;">
                    ...
                    <p><a href="donner_home.php">Dashboard</a> / Manage Causes</p>
                </div>
                <div class="col-md-3" style="text-align:right; padding-right:70px; padding-top:20px;">
                    <a href="donner_cause_add.php" class="btn btn-success">Add Cause</a>
                </div>
            </div>
            <div class="row align-items-start py-3">
                <div class="col-lg-9" style="height:800px; overflow-y:scroll;">
                    ...
                    <?php 
                      ...
                      $sql = "SELECT * FROM causes where cause_id <> 1 ORDER BY cause_id";
                      $result = mysqli_query($conn, $sql);
                      if($result){
                        ...
                        <div class="card-body" style="margin-bottom:20px">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="donner_cause_search.php?category=Money">Money</a>
                                ...
                                ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="donner_cause_search.php?category=Food">Food</a>
                                ...
                                ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="donner_cause_search.php?category=Cloth">Cloths</a>
                                ...
                                ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a href="donner_cause_search.php?category=Medicine">Medicine</a>
