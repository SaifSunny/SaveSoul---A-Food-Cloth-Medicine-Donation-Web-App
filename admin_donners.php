        ...
        <div class="main">
            <div class="row d-flex justify-content-between">
                <div class="col-md-9" style="padding-bottom:30px;">
                    ...
                    <p><a href="admin_home.php">Dashboard</a> / Manage Donners</p>
                </div>
                <div class="col-md-3" style="text-align:right; padding-right:70px; padding-top:20px;">
                    <a href="admin_donner_add.php" class="btn btn-success">Add Donners</a>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            if($result){
                                                ...
                                                $contact=$row['contact'];
                                                $email=$row['email'];
                                                $image=$row['donner_img'];
                                        ?>
                                        <tr>
                                            <td><img src="./img/donners/<?php echo $image?>"
                                            ...
                                            <td><a href="admin_donner_delete.php?id=<?php echo $id ?>"
