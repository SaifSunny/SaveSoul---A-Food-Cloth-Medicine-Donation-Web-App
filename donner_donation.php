    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="donner_donation.php" class="nav-link active" aria-current="page"
        ...
        <div class="main">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p><a href="">Dashboard</a> / Donation History</p>
                </div>
            </div>
                    ...
                    <div style="text-align:center; height:500px;">
                        <div style="padding:20px 40px; text-align:center;font-size:18px;">
                            <table class="table" style="font-size: 14px;color:#222;vertical-align:middle">
                                ...
                                <tbody>
                                    <?php 
                                            $sql = "SELECT * FROM donation Where poster_id = $donner_id AND `role`='Donner' and status >0";
                                            $result = mysqli_query($conn, $sql);
                                            if($result){
