        ...
        <div class="main">
            <div class="row">
                <div class="col-md-9" style="padding-bottom:30px;">
                    <h2 style="font-weight:600">Posts Detail</h2>
                    <p><a href="donner_home.php">Dashboard</a> / <a href="donner_blog.php"> Blog Posts</a> / Posts
                        Detail</p>
                </div>
            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p style="font-size:15px"><i class="fa fa-user text-success"></i> <?php echo $name?>
                                        &nbsp;
                                        &nbsp; &nbsp;<i class="fa fa-clock text-success"></i> <?php echo $post_date?>
                                    </p>
                                </div>
                                <div>
                                    <?php
                                            ...
                                            ?>
                                    <a href="donner_blog_delete.php?blog_id=<?php echo $id?>"
