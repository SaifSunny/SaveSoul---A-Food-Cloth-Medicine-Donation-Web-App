...
$description=$row['description'];
    ...
    if(isset($_POST['submit_money'])){
        ...
        VALUES ('$cause_id','$ngo_id', 'NGO', '$amount','1', '$date', '$card_number', '$card_month', '$card_year', '$card_cv', 'Money')";
    ...
    if(isset($_POST['submit_item'])){
        ...
        VALUES ('$ngo_id','NGO', '$cause_id', '$amount','0', '$date', '$address','$category','$pickup_date')";
        $query_run2 = mysqli_query($conn, $query2);
        ...
        <div class="main">
            <div class="row">
                <div class="col-md-9" style="padding-bottom:20px;">
                    ...
                    <p><a href="ngo_home.php">Dashboard</a> / <a href="ngo_causes.php">Manage Causes</a> / Cause Details
                    </p>
                </div>
                    ...
                    <div class="card-body d-flex" style="margin: 20px">
                        <div style="width:100%">
                            ...
                            ?>
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <a href="ngo_blog_details.php?blog_id=<?php echo $id?>"><img
