...
if(isset($_POST['submit'])){
    ...
    if (strlen($p) > 5) {
        ...
        $query = "SELECT * FROM ngo WHERE registration_id = '$registration_id'";
        $query_run = mysqli_query($conn, $query);
        if (!$query_run->num_rows > 0) {

            $query = "SELECT * FROM ngo WHERE registration_id = '$registration_id' AND email = '$email'";
            $query_run = mysqli_query($conn, $query);
            if(!$query_run->num_rows > 0){
                ...
                if( in_array($imageFileType,$extensions_arr) ){
                    ...
                    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
                        ...
                        $query2 = "INSERT INTO ngo(ngo_name,contact,address,city,zip,email,`password`, registration_id, established, `ngo_img`,username, verified, about)
                        VALUES ('$ngo_name','$contact','$address','$city','$zip', '$email', '$password', '$registration_id','$established', '$name', '$username', '1', '$about')";
                        $query_run2 = mysqli_query($conn, $query2);
            
                        if ($query_run2) {
                            $cls="success";
                            $error = "NGO Successfully Added.";
                        } 
                        else {
                            $cls="danger";
        ...
        <div class="main">
            <div class="row d-flex justify-content-between">
                <div class="col-md-9" style="">
                    ...
                    <p><a href="admin_home.php">Dashboard</a> / <a href="admin_ngos.php">Manage NGOs</a> / Add
                        NGO</p>
                </div>
                      ...
                      <input type="text" class="form-control" name="established" id="established"
                        placeholder="Established">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                    <div class="form-group" style="padding:10px">
                      <label style="padding-bottom:10px;">About the NGO</label> <br>
                      <textarea name="about" id="about" class="form-control" cols="90" rows="6"
                        placeholder="Write about the NGO"></textarea>
                    </div>
                  </div>
                                    </div>
