        ...
        <div class="main">
            <div class="row d-flex justify-content-between">
                <div class="col-md-9" style="padding-bottom:30px;">
                    ...
                    <p><a href="admin_home.php">Dashboard</a> / Manage Causes</p>
                </div>
                <div class="col-md-3" style="text-align:right; padding-right:70px; padding-top:20px;">
                    <a href="admin_cause_add.php" class="btn btn-success">Add Causes</a>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            if($result){
                                                ...
                                                $sql10 = "SELECT SUM(amount) as total FROM donation WHERE `cause_id`= $id AND `status` = 1";
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src="./img/<?php echo $dir."/".$pimg?>"
                                            ...
                                            <td><a href="admin_cause_delete.php?id=<?php echo $id ?>"
